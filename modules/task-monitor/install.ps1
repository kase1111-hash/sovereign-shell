...
<#
.SYNOPSIS
    Installs the Sovereign Task Monitor.
#>

param(
    [string]$BinaryPath = "$PSScriptRoot\src-tauri\target\release\sovereign-task-monitor.exe"
)
...
Write-Host "[install] Sovereign Task Monitor installer" -ForegroundColor Cyan
